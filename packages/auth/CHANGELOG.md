...
- [`3807127`](https://github.com/Navigraph/navigraph-js-sdk/commit/38071278aae4345d9d30cd628388b15e59be28b4) Thanks [@SkySails](https://github.com/SkySails)! - Reduce amount of `onAuthStateChanged` events sent during init process, making it easier to track when the module is properly initialized.
